...
app.controller("myFirstController", function($scope, $http, $compile) {
  ...
  $scope.fetch = function() {
    if ($scope.link && ($scope.link.match("youtu") || $scope.link.match("vimeo"))) {
      document.getElementById("iframe").src = $scope.link;
      $scope.sliderX = "0";
      $scope.sliderY = "0";
      $scope.input = {
...
function imageResize() {
  ...
  var iframe_width = document.getElementById("iframe").clientWidth;
  var height = (width + 2) * 0.56;
  var iframe_height = (iframe_width + 2) * 0.56;
  document.getElementById("iframe").style.height = iframe_height + "px";
